...
vim.keymap.set("v", "<leader>y", '<cmd>lua require("osc52").copy_visual()<CR>', { desc = "Copy (to clipboard)" })
...
vim.keymap.set("n", "<leader>vpp", "<cmd>e ~/.config/nvim/lua/dhaval/packer.lua<CR>");
